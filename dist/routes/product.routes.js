 ...
 */
router.post('/', (0, auth_middleware_1.requireRole)('ADMIN', 'MANAGER'), (0, validate_middleware_1.validateBody)(product_schema_1.createProductSchema), productController.create.bind(productController));
/**
 * @swagger
 * /api/products:
 *   get:
 ...
 */
router.get('/:id', (0, validate_middleware_1.validateParams)(common_schema_1.idParamSchema), productController.getById.bind(productController));
/**
 * @swagger
 * /api/products/{id}:
 *   put:
 ...
 */
router.put('/:id', (0, auth_middleware_1.requireRole)('ADMIN', 'MANAGER'), (0, validate_middleware_1.validateParams)(common_schema_1.idParamSchema), (0, validate_middleware_1.validateBody)(product_schema_1.updateProductSchema), productController.update.bind(productController));
/**
 * @swagger
 * /api/products/{id}:
 *   delete:
 ...
 *         description: Produto não encontrado
 */
router.delete('/:id', (0, auth_middleware_1.requireRole)('ADMIN'), (0, validate_middleware_1.validateParams)(common_schema_1.idParamSchema), productController.delete.bind(productController));
/**
 * @swagger
 ...
 *         description: Produto não encontrado
 */
router.post('/stock/movements', (0, auth_middleware_1.requireRole)('ADMIN', 'MANAGER'), (0, validate_middleware_1.validateBody)(product_schema_1.createStockMovementSchema), productController.addStockMovement.bind(productController));
/**
 * @swagger
 * /api/products/stock/movements:
 *   get:
